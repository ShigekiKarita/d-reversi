...
class BoardTab : HorizontalLayout {
    this(string name = "board") {
        super(name);
        this.layoutWidth(FILL_PARENT).layoutHeight(FILL_PARENT);
        auto c = new BlockWidget;
        this.addChild(c);
    }
}

class BlockWidget : CanvasWidget {
    ...
    override void doDraw(DrawBuf buf, Rect rc) {
        //Log.w("this.onDrawListener clipRect=" ~ to!string(buf.clipRect));
        buf.fill(0xFFFFFF);
        int x = rc.left;
        int y = rc.top;
        buf.fillRect(Rect(x+20, y+20, x+150, y+200), 0x80FF80);

        auto rect = Rect(x+90, y+80, x+250, y+250);
        buf.fillRect(rect, 0x80FF80FF);
        Rect(x+90, y+80, x+250, y+250);

        this.font.drawText(buf, x + 40, y + 50, "fillRect()"d, 0xC080C0);

        // buf.drawFrame(Rect(x + 400, y + 30, x + 550, y + 150), 0x204060, Rect(2,3,4,5), 0x80704020);
        // this.font.drawText(buf, x + 400, y + 5, "drawFrame()"d, 0x208020);
        // this.font.drawText(buf, x + 300, y + 100, "drawPixel()"d, 0x000080);
        // for (int i = 0; i < 80; i++)
        //     buf.drawPixel(x+300 + i * 4, y+140 + i * 3 % 100, 0xFF0000 + i * 2);
        // this.font.drawText(buf, x + 300, y + 420, "drawLine()"d, 0x800020);
        ...
        // this.font.drawText(buf, x + 190, y + 260, "polyLineF()"d, 0x603010);
        ...
        // this.font.drawText(buf, x + 500, y + 460, "fillPolyF()"d, 0x203050);

        // buf.drawEllipseF(x+300, y+600, 200, 150, 3, 0x80008000, 0x804040FF);
        // this.font.drawText(buf, x + 300, y + 600, "fillEllipseF()"d, 0x208050);

        // buf.drawEllipseArcF(x+540, y+600, 150, 180, 45, 130, 3, 0x40008000, 0x804040FF);
        // this.font.drawText(buf, x + 540, y + 580, "drawEllipseArcF()"d, 0x208050);
    }
}

class ListTab : HorizontalLayout {
...
extern (C) int UIAppMain(string[] args)
{
    ...
    auto canvas = new BoardTab;
    tabs.addTab(canvas, "canvas"d);

    auto list = new ListTab;
    tabs.addTab(list, "log"d);
